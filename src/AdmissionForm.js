...
class AdmissionForm extends Component {
  ...
  handleFormValidation() {
    const { fullname, email, regdNo, year, phone, confirmphone, branch,interestedDomain, codingProfile, githubProfile } =
      this.state;
    let formErrors = {};
    ...
    //branch
    if (interestedDomain === "" || interestedDomain === "select") {
      formIsValid = false;
      formErrors["interestedDomainErr"] = "Select interestedDomain.";
    }
    ...
    if (!githubProfile) {
      formIsValid = false;
      formErrors["githubProfileErr"] = "githubProfile is required.";
      // return <Link to="ThankYou.js" />;
    }
    ...
    return (
      <>
        <div className="formDiv">
          <div className="heading">ENIGMA Induction </div>
              ...
              <form onSubmit={this.handleSubmit}>
                ...
                <div>
                  ...
                  <select
                    ...
                    value={this.state.interestedDomain}
                    onChange={this.handleChange}
                    className={interestedDomainErr ? " showError" : ""}
                    onInvalid={(e) =>
                      e.target.setCustomValidity("Interested Domain is required")
                    }
                    onInput={(e) => e.target.setCustomValidity("")}
                    required
                  >
                    ...
                    <option value="CP">Competetive Programming</option>
                    <option value="Cyber">Cyber Security</option>
                    <option value="UI/UX">UI / UX</option>
                    <option value="GD">Graphics Designing</option>
                    <option value="VE">Video Editing</option>
                    <option value="CE">Content Writing</option>
                  </select>
                  {interestedDomainErr && (
                    <div style={{ color: "red", paddingBottom: 10 }}>
                      {interestedDomainErr}
